...
! function() {
    ...
    var l, n = document.querySelectorAll(".nav-link.mega-dropdown"),
        n = (n && n.forEach(e => {
            new MegaDropdown(e)
    ...
    }), n = n.querySelector("i"), "light" === s ? (n.classList.add("bx-sun"), new bootstrap.Tooltip(n, {
        title: "Light Mode",
        fallbackPlacements: ["bottom"]
    })) : "dark" === s ? (n.classList.add("bx-moon"), new bootstrap.Tooltip(n, {
        title: "Dark Mode",
        fallbackPlacements: ["bottom"]
    })) : (n.classList.add("bx-desktop"), new bootstrap.Tooltip(n, {
        title: "System Mode",
        fallbackPlacements: ["bottom"]
    }))), "system" === (l = s) && (l = window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"), [].slice.call(document.querySelectorAll("[data-app-" + l + "-img]")).map(function(e) {
